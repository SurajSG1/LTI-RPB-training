package com.user.service.application.controller;
...
import com.user.service.application.service.UserService;
...
public class UserDetailsController {
	...
	@PostMapping()
	public ResponseEntity<UserDetailDto> register(@RequestBody RegisterDetailsDto registerDto) throws Exception {
